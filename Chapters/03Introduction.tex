...
as the primary selection criteria, which is often too general 
...
suitable machine learning methods, use the research 
literature to justify those recommendations, and lower the 
barrier to early-stage implementation. 
To address this, the following research questions are defined:
