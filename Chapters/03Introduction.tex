...
system, called MLguide, is developed that combines structured knowledge 
...
\begin{itemize}
    ...
    \item Chapter 3 presents the methodological framework and system overview
    \item Chapter 4 describes the system development
    \item Chapter 5 describes the research approach
    \item Chapter 6 presents the system implementation
    \item Chapter 7 presents the results
    \item Chapter 8 discusses the findings and limitations
    \item Chapter 9 concludes the thesis and suggests future work
\end{itemize}
