...
The system was developed incrementally over the course of the master's project. 
New components were added and tested continuously, and design decisions were 
adjusted based on observations made during development. 
This approach is consistent with the iterative nature of the DSR process, 
in which the researcher moves between design, demonstration, and evaluation 
to improve the artifact over time 
\parencite{peffers2007design_science_research_methodology}. 
Throughout development, the author continuously tested both the functionality 
of individual features and the relevance and usefulness of the system output.

\section{User Testing}
\subsection{Setup and Context}

The system was evaluated through two rounds of user testing in a machine 
learning course at NTNU, where students used MLguide as part of their 
