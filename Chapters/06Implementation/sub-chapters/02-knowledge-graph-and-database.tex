...
Section~\ref{subsection:ml-ontology} was re-applied to propagate 
\texttt{used\_for} and \texttt{belongs\_to} relations to the new 
instances through their \texttt{skos:broader} hierarchies.

\texttt{mla:ML\_task\_family} instances were added to group related 
