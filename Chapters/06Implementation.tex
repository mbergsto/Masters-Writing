...
\begin{figure}[H]
    ...
    \caption{Sequence diagram of the recommendation process in MLguide}
...
\begin{figure}
    ...
    \caption{Flowchart of the ranking process in MLguide, including similarity scoring and feedback boost}
...
\begin{figure}[H]
    ...
    \caption{Sequence diagram of the notebook generation process in MLguide}
...
\begin{figure}[H]
    ...
    \caption{Flowchart of the article retrieval and knowledge extraction process in MLguide}
