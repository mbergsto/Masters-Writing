...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{Figures/06-implementation/recommendation-article-sequence.png}
    \caption{Sequence diagram of the article-based recommendation process in MLguide}
    \label{fig:recommendation-article-sequence}
\end{figure}
