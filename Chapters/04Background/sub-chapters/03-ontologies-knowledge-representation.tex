...
\begin{figure}[H]
    ...
    \caption{ML Ontology schema. Reproduced from 
    \textcite{humm2026industry_ready_machine_learning_ontology}, 
...
\begin{figure}[H]
    ...
    \caption{ML Ontology classes. Reproduced from 
    \textcite{humm2026industry_ready_machine_learning_ontology}, 
    licensed under CC BY 4.0.}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{Figures/ml-ontology-task-hierarchy.png}
    \caption{ML task hierarchy in ML Ontology. Reproduced from 
    \textcite{humm2026industry_ready_machine_learning_ontology}, 
    licensed under CC BY 4.0.}
