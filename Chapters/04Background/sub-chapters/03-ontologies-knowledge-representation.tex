...
Table~\ref{tab:ml-approach-properties} lists the properties 
associated with \texttt{ML\_approach} instances in ML Ontology.
...
Table~\ref{tab:ml-approach-coverage} shows how many of the 
122 \texttt{ML\_approach} instances have each property populated.
...
explicitly. Figure~\ref{fig:ml-ontology-task-hierarchy} 
illustrates the task hierarchy for supervised and 
