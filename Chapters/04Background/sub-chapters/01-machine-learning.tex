...
human brain, consisting of processing units organized in input, hidden, and 
output layers 
\parencite{shrestha2019review_deep_learning_algorithms_architectures}. 
Deep learning refers to neural networks with many such layers. By stacking 
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\textwidth]{Figures/neural-networks-table.png}
    \caption{Summary and comparison of common neural network architectures, based on 
    \textcite{sarker2021machine_learning_algorithms_real_world_applications_research_directions}, 
...
or linear methods 
\parencite{zhang2020taxonomy_reinforcement_learning_algorithms}. 
A key development in DRL was the deep Q-network (DQN), which uses a neural 
