...
\textbf{Sett inn et delkapittel om ML metoder? F.eks:
Formidle at antallet konkrete metoder er stort.
Vise at metodene varierer langs noen få meningsfulle dimensjoner som faktisk har praktisk betydning: tolkbarhet, datakrav, robusthet, og ytelse
Det vil gjøre begrunnelsen av Ontologi mer meningsfull, siden det er nettopp disse egenskapene som kan representeres eksplisitt i en ontologi og brukes for inferens.}

\subsection{Machine Learning Methods: Categories and Attributes}
...
\textbf{Nevne spesifikke AutoML verktøy som er relevante? Eller ta det i exisiting tools}