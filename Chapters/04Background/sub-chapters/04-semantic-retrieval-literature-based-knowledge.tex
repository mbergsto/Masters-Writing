...
Section~\ref{subsec:sentence-embeddings} is an example of a 
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{Figures/bi-vs-cross-encoder.png}
    \caption{Bi-encoder and cross-encoder architectures. The 
    ...
    inputs and producing a direct relevance score.}
...
consists of shorter sentences presenting only the most 
