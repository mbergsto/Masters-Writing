...
The process in this thesis follows a design-centered initiation, where
development of the system starts before the research questions are fully formalised 
\parencite{peffers2007design_science_research_methodology}. 
...
Mlguide is developed as a direct continuation of the work done in the pre-master project \parencite{bergsto2026mlselection}.
...
the system without installation. Supporting user feedback on method recommendations is also identified as 
a direction for future development in the pre-master project 
\parencite{bergsto2026mlselection}, with the intention that user ratings 
contribute to method ranking over time.

\section{Incremental and Iterative Development}

MLguide was developed incrementally over the course of the master's project. 
New features and components are built and deployed one at a time, each adding 
...
the author continuously tests individual features and the overall system output 
to check that behaviour is correct and results are useful.

The development also has an iterative character. Feedback from the thesis 
supervisor informs adjustments to the system design and priorities through the development period. 
In addition, two rounds of user testing were conducted, 
and the findings are used to evaluate and adjust the system. 
...
User testing is conducted in collaboration with the course TMM4128 Machine 
...
its intended user group. Students use MLguide as part of their course 
projects. The participants are engineering students with limited prior 
experience with machine learning. Feedback can be collected through a feedback form 
accessable in MLguide and from the students' project reports. 
...
unsupervised learning. Students are asked to compare at least three 
techniques, which makes MLguide a natural fit. The system can be used 
early in the project to get method recommendations, or later as a 
comparison against methods already selected.

The second project is more open-ended. Students are asked to analyse 
...
MLguide can be used in two ways in this context: to find relevant 
