...
From \parencite{cormack2009reciprocal_rank_fusion}:

Om selve formelen og valg av k:
...
Om hvorfor reciprocal rank og ikke eksponentiell:
"while highly-ranked documents are more important, the importance of lower-ranked documents does not vanish as it would were, say, an exponential function used."

Om å kombinere rangeringer uten å ta hensyn til de underliggende scorene:
...
From \parencite{ricci2010recommender_systems_handbook} :
