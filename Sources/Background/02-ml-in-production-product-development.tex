...
"In manufacturing application, supervised ML techniques are mostly applied due to the data-rich but knowledge-sparse nature of the problems [...] partly due to the availability of (a) expert feedback (e.g. quality) and (b) the labeled instances."
...
From \parencite{plathottam2023review_ai_applications_manufacturing_operations} :
...
From \parencite{nti2022applications_ai_engineering_manufacturing_systematic_review} :
