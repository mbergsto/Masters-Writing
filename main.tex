...
\usepackage{setspace} %to set line spacing, for example with \onehalfspacing or \setstretch{1.2}
...
\input{Chapters/05Methodology-System-Overview.tex}
\cleardoublepage


\chapter{Implementation}
\input{Chapters/06Implementation/06Implementation.tex}
\cleardoublepage
