...
\usepackage{tabularx} %for tables with auto-width columns
...
\usepackage{pdflscape} %to be able to make landscape pages, for example for wide tables
...
\usepackage{parskip} % to add space between paragraphs and remove indentation. Can still set the spacing manually with setlength{\parskip}{1em}
...
\noindent  \textcolor{gray}{\large Martin Bergstø} \\
\vspace{1cm}

\noindent \textbf{\Large Ontology-Driven Decision Support} \\
\noindent \textbf{\Large for Machine Learning Method Selection} \\
\noindent \textbf{\Large in Product Development and Production} \\
\vspace{0.5cm}

\noindent {\large Combining Semantic Literature Retrieval with} \\
\noindent {\large Ontology-Based Filtering and Implementation Support} \\


\vspace{7cm}
\noindent Master's thesis in Engineering and ICT \\
...
\input{Chapters/04Background/04Background.tex}
\cleardoublepage


\chapter{Research Methodology and System Overview}
\input{Chapters/05Methodology/05-1Methodology-System-Overview.tex}
\cleardoublepage


\chapter{System Design and Development}
\input{Chapters/05Methodology/05-2System-Design-Development.tex}
\cleardoublepage


\chapter{Investigating the Research Questions}
\input{Chapters/05Methodology/05-3Research-Approach.tex}
\cleardoublepage


\chapter{Implementation}
\input{Chapters/06Implementation}
\cleardoublepage
