...
\noindent \textbf{\Large Ontology-Driven Roadmap for Machine Learning Adoption in Product Development and Production} \\
\vspace{0.5cm}
...
\vspace{7cm}
\noindent Master's thesis in Industrial ICT \\
...
\input{Chapters/07Implementation}
\cleardoublepage
